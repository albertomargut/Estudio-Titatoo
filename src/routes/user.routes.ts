...
router.get("/getArtistUser/:id", auth, isAdmin, userController.getArtistUser);//NOS TRAEMOS EL USER_ID DE NUESTRO ARTISTA
...
router.get("/getArtistByUser/:id", auth, isAdmin, userController.getArtistByUser);//NOS TRAEMOS EL ARTISTA Y EL USER, LOS DISEÑOS DEL ARTISTA, SUS CITAS Y LOS DETALLES DEL CLIENTE, TODO CON EL ID DE USER(TOKEN DESDE EL FRONT)
